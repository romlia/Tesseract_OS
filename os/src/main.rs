...
use prismatic_core::{SensoryEvent, GlobalContext, temporal, PIDController, SHUTDOWN, LockFreeEventBus, BackpressurePolicy};
use std::sync::Arc;
...
fn main() {
    ...
    let bus: Arc<dyn prismatic_core::bus::EventBus<SensoryEvent>> = Arc::new(LockFreeEventBus::new(BackpressurePolicy::DropOldest));
